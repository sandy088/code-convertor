...
export const FooterFour = () => {
  return (
    <footer className="container mx-auto px-10 md:px-0 py-10 flex flex-col items-center">
      <div className="flex items-center space-x-6">
        <div>
          <img src={convLogo} height={50} width={50}/>
        </div>
      ...
      <div className="flex space-x-6 mt-8 text-white">
        <span className="hover:scale-[1.2] hover:text-indigo-600">
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mt-6">
          Copyright © 2023 Code Convertor. All rights reserved.
      </p>
    </footer>
  );
};

FooterFour.displayName = "FooterFour";
